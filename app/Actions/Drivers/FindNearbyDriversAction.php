...
{
    public function execute(float $latitude, float $longitude, float $radiusInMeters = 5000.0, DriverStatus|string|null $status = DriverStatus::AVAILABLE, int $limit = 20): Collection {
        $query = Driver::query()
            ->withCoordinates()
